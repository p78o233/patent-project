...
//            ")" +
            ...
            "</if>" +
            "</script>")
    List<BaseData> getResultDetail(@Param("keywords") List<String> keywords, @Param("company") String company, @Param("applyYear") int applyYear, @Param("applyType") int applyType, @Param("effectiveness") int effectiveness);
